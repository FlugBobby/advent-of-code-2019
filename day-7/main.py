...
def part_1():
    ...
    for phase in itertools.permutations(phases):
        amplification = Amplification(inputs[sys.argv[1]], phase)
        signal = int(amplification.run_once())
...
def part_2():
    ...
    for _phases in itertools.permutations(phases):
        print("phases:", _phases)
        amplification = Amplification(inputs[sys.argv[1]], _phases)
        signal = int(amplification.run_feedback())
